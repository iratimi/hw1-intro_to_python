...
def is_two_objects_is_the_same_objects(first: Any, second: Any) -> bool:
    """
    If @first and @second refer to the same object
    In another case should return False
    """
...
def multiple_ints(first_value: int, second_value: int) -> int:
    ...
    Params:
        ...
        second_value: value for multiply
    Returns:
        Product of elements
    """
...
def alphabet() -> dict:
    """
    Create dict which values that are alphabetic characters. And keys are their numbers in alphabet
